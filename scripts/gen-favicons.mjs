...
// Same brand mark as app/icon.svg, tuned for tiny sizes: a touch bolder P, slightly
// larger corner radius so it reads as a rounded tile even at 16px.
const svg = (size) => `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 64 64">
  ...
  <g transform="translate(32 32) scale(1.12) translate(-32 -32)">
    <path d="M22 48V16H34C38.4 16 42 17.6 44.2 20.2C46.4 22.8 47 26 47 28.5C47 31 46.4 34.2 44.2 36.8C42 39.4 38.4 41 34 41H30V48H22ZM30 33.5H33.5C35 33.5 36.2 33 37 32.2C37.8 31.4 38.2 30.2 38.2 28.5C38.2 26.8 37.8 25.6 37 24.8C36.2 24 35 23.5 33.5 23.5H30V33.5Z" fill="#ffffff"/>
  </g>
</svg>`;
...
writeFileSync('public/site.webmanifest', JSON.stringify({
  ...
  start_url: '/', display: 'standalone', background_color: '#0a0a0f', theme_color: '#6366f1',
  icons: [
