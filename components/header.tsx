    ...
    >
      <div className="flex items-center w-full px-4 md:px-5 gap-3">
        ...
        <button
          ...
          onMouseEnter={e => ((e.currentTarget as HTMLElement).style.borderColor = 'var(--glass-border-xl)')}
          onMouseLeave={e => ((e.currentTarget as HTMLElement).style.borderColor = 'var(--glass-border-md)')}
        >
          <Search className="w-3.5 h-3.5 shrink-0" />
          <span className="text-sm hidden sm:inline" style={{ fontSize: 13, color: 'var(--text-muted)' }}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            ...
            <span className="gradient-text font-medium">{t('header', 'aiHelp')}</span>
          </button>
          ...
          <Link
            ...
            onMouseEnter={e => ((e.currentTarget as HTMLElement).style.background = 'rgba(34,211,238,0.13)')}
