export function LogoMark({ size = 32, className = '' }: { size?: number; className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="64" height="64" rx="14" className="fill-neutral-900 dark:fill-neutral-100" />
      <path
...
export function LogoFull({ height = 28, className = '' }: { height?: number; className?: string }) {
  ...
  return (
    <svg
      ...
      className={className}
    >
      <rect width="48" height="48" rx="11" className="fill-neutral-900 dark:fill-neutral-100" />
      <path
