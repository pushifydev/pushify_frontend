...
export function IndexSection({
  ...
  return (
    <div>
      <h3 className="dash-section-label mb-2">{t('databases', 'studioIndexes')}</h3>
        ...
        {loading ? (
          ...
          indexes.map((index, position) => (
            <div
              ...
              style={{ borderTop: position === 0 ? 'none' : '1px solid var(--border-subtle)' }}
            >
              ...
              {!index.isPrimary &&
                (confirmDrop === index.name ? (
                  ...
                  <button
                    ...
                    aria-label={t('databases', 'studioDropIndex')}
                  >
      ...
      {open ? (
        <div
          className="rounded-[10px] px-3 py-3 mt-3 space-y-3"
              ...
              {columns.map((column) => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={active}
                    className="px-2.5 py-1 rounded-full text-xs transition-colors hover:bg-(--hover-overlay-md) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--text-primary)"
                    style={{
                      ...mono,
        ...
        <button type="button" onClick={() => setOpen(true)} className="btn btn-secondary btn-sm mt-3">
