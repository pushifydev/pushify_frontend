...
function DomainsTab({
  ...
  return (
    <div className="space-y-4">
      ...
      {autoSubdomain && (
        <div className="p-4 rounded-lg bg-[var(--bg-secondary)] border border-[var(--accent-cyan)]/30 border-l-4 border-l-[var(--accent-cyan)]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="terminal-text font-medium text-[var(--text-primary)] hover:text-[var(--accent-cyan)] transition-colors flex items-center gap-1 mt-0.5"
                >
                  {autoSubdomain.domain}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-xs font-medium text-[var(--text-muted)] uppercase tracking-wider">Custom Domain</span>
