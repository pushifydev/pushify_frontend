    ...
    <div className="dash-page max-w-5xl space-y-6 animate-slide-in">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {servers.length > 0 && (
            <div className="flex gap-1 p-1 rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-secondary)]">
              <button
                type="button"
            ...
            return (
              ...
              >
                ...
                {server.status === 'running' && server.setupStatus !== 'completed' && (
                  <div
                    className="mb-3 px-3 py-2 rounded-lg flex items-center gap-2 border border-[var(--border-subtle)]"
                ...
                {server.ipv4 && (
                  <div
                    className="flex items-center gap-2 pt-3 text-xs border-t border-[var(--border-subtle)]"
                    style={{ color: 'var(--text-muted)' }}
                  >
