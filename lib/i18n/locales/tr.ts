...
export const tr: TranslationKeys = {
  ...
  auth: {
    ...
    ssoRequired: 'Kuruluşunuz kendi kimlik sağlayıcısı üzerinden giriş yapıyor.',
    continueWithSso: 'SSO ile devam et',
    ssoCompleting: 'Giriş tamamlanıyor…',
    ssoFailed: 'Tek oturum açma tamamlanamadı. Tekrar deneyin.',
    signIn: 'Giriş yap',
    signUp: 'Kayıt ol',
  ...
  landing: {
    ...
    databasesOneClickDesc: 'PostgreSQL, MySQL, Redis veya MongoDB\'yi otomatik yedekleme ve güvenli erişim ile başlatın. DevOps uzmanlığı gerekmez.',
    cliLabel: 'CLI',
  ...
  homepage: {
    ...
    statsBuildpacks: 'Dil buildpack\'i',
  ...
  projectDetail: {
    ...
    failureRepositoryAccess: 'Pushify repoyu okuyamadı. Ayarlar → GitHub erişimi bölümünden düzelt: repoyu görebilen bir GitHub hesabı bağla ya da GitHub App\'i repo sahibine kur.',
    gitAccessTitle: 'GitHub erişimi',
    gitAccessDesc: 'Pushify\'ın bu repoyu çekmek için kullandığı GitHub bağlantısı.',
    gitAccessOkApp: 'Pushify bu repoya GitHub App üzerinden erişiyor:',
    gitAccessOkOAuth: 'Pushify bu repoya şu GitHub hesabıyla erişiyor:',
    gitAccessViewerOnly: 'Bu repoyu yalnızca senin GitHub hesabın okuyabiliyor: senin başlattığın deploy\'lar çalışır, push ile otomatik deploy\'lar başarısız olur. Herkes için düzeltmek için GitHub App\'i repo sahibine kur.',
    gitAccessPublic: 'Herkese açık repo — deploy için bağlantı gerekmez.',
    gitAccessNone: 'Pushify bu repoya erişemiyor, bu yüzden deploy\'lar başarısız oluyor. Repoyu görebilen bir GitHub hesabı bağla ya da GitHub App\'i {owner} hesabına kur.',
    gitAccessUnknown: 'Erişimi kontrol etmek için GitHub\'a ulaşılamadı. Birazdan tekrar dene.',
    ...
    dnsLoading: 'DNS bilgisi yükleniyor...',
    dnsConfiguration: 'DNS yapılandırması',
    dnsAddRecord: 'DNS sağlayıcında sunucuyu gösteren bir A kaydı ekle:',
    dnsType: 'Tür',
    dnsName: 'Ad',
    dnsValue: 'Değer',
    dnsTwinHint: '{twin} de çalışsın diye bunu da ekle — Pushify onu {domain} adresine yönlendirir ve aynı SSL sertifikasına ekler.',
    dnsReady: 'DNS doğru ayarlanmış. Kurulumu tamamlamak için doğrula.',
    dnsPointsElsewhere: 'DNS şu an {current} adresini gösteriyor. {server} olarak değiştir.',
    dnsNotFound: 'Henüz DNS kaydı bulunamadı. Yukarıdaki A kaydını ekle ve yayılması için birkaç dakika bekle.',
    dnsNoServer: 'Henüz yönlendirilecek bir sunucu yok. Proje ayarlarından bir sunucu ata ya da projeyi bir kez deploy et.',
    dnsUnavailable: 'DNS bilgisi yüklenemedi.',
    dnsShow: 'DNS kurulumunu göster',
    ...
    logsHelpHistorical: 'Geçmiş — sunucuda periyodik kaydedilen loglar (planınızın sakladığı süre kadar tutulur).',
    // Environment tab
    ...
    composePath: 'Docker Compose dosyası',
    composePathHint: 'Depoyu build etmek için boş bırakın. Bir yol girerseniz (docker-compose.yml) depo bir yığın olarak deploy edilir — çoğu depoda yerel geliştirme için bir tane bulunduğu için kendiliğinden kullanılmaz.',
    composePathActive: 'Bu proje o dosyadaki yığını deploy ediyor. Host\'a yalnızca servis edilen servis yayınlanır; diğerleri yığın içinde birbirine adıyla erişir.',
    composeService: 'Servis edilecek servis',
    composeServiceHint: 'Nginx\'in proxy\'leyeceği servis. Birden fazla servis port yayınlıyorsa gerekli.',
    dockerImage: 'Docker imajı',
    dockerImageHint: 'Depodan build almak için boş bırakın. Doldurursanız hazır bir imaj deploy edilir (ghcr.io/acme/api:1.4) — özel imajlar için Ayarlar → Özel registry\'ler.',
    dockerImageActive: 'Bu proje yukarıdaki imajı deploy ediyor; aşağıdaki depo ayarları kullanılmıyor. Etiketi yeniden çekmek için deploy alın.',
    ...
    replicasManagedHint: 'Otomatik ölçekleme yönetiyor — bu, şu anki sayı.',
    autoscale: 'Otomatik ölçekle',
    autoscaleHint: 'CPU yüksek kaldığında bir container ekler, düşük kaldığında birini kaldırır. Adım adım ilerler ve değişiklikler arasında bekler, böylece gidip gelmez. Pro ve üzeri planlarda.',
    autoscaleMin: 'En az container',
    autoscaleMax: 'En fazla container',
    autoscaleObserve: 'Sadece ne yapacağını bildir',
    autoscaleObserveHint: 'Karar verir ve kaydeder, ama hiçbir şeyi değiştirmez. Eşikler, sizin trafiğinizle karşılaşana kadar makul birer tahmindir — harekete geçmesine izin vermeden önce birkaç gün izleyin.',
    scaleHistory: 'Son kararlar',
    scaleHistoryEmpty: 'Henüz yok. Kararlar verildikçe burada görünür.',
    scaleNotApplied: 'uygulanmadı',
    ...
    staging: 'Staging',
    stagingNotDeployed: 'Henüz deploy edilmedi',
    deployStaging: 'Staging deploy et',
    promoteToProduction: 'Production’a al',
    promoteHint: 'Staging’de çalışan commit’i production değişkenleriyle yeniden derler.',
    promoteStarted: 'Staging production’a alınıyor',
    ...
    installGithubWebhookHint: 'Repoya GitHub erişimi (bkz. GitHub erişimi) ve webhook gizli anahtarı gerekir',
  ...
  newProject: {
    ...
    githubOauthPublicOnly: 'Bu GitHub bağlantısı yalnızca herkese açık repoları görebiliyor. Özel repolarına da erişim vermek için yeniden bağlan ya da GitHub App\'i kullan.',
    githubReconnect: 'Yeniden bağla',
    githubOrConnectAccount: 'Ya da GitHub hesabınla bağlan',
    ...
    githubAppAddAccount: 'Başka hesap ekle',
    githubAppUseOAuth: 'Bunun yerine GitHub hesabımı kullan',
    githubAppUsePicker: 'GitHub App repolarını kullan',
    githubAppNoRepos: 'Bu kurulum henüz hiçbir repoya erişemiyor — GitHub’dan repo ekleyin.',
  ...
  logs: {
    ...
    allTypes: 'Tümü',
    allContainers: 'Tüm container\'lar',
    range1h: 'Son 1 saat',
    range6h: 'Son 6 saat',
    ...
    historyHint: 'Saklanan container loglarında arayın — zaman aralığı, container ve terim seçin.',
  ...
  sso: {
    ...
    description: 'Kuruluşunuzun kendi kimlik sağlayıcısı üzerinden, OpenID Connect ile giriş.',
    provider: 'Kimlik sağlayıcı',
    redirectUri: 'Sağlayıcınıza yönlendirme adresi olarak bunu girin',
    copy: 'Kopyala',
    issuer: 'Issuer adresi',
    issuerHint: 'Okta, Entra ID, Google Workspace, Auth0, Keycloak — OpenID yapılandırmasındaki issuer.',
    clientId: 'Client ID',
    clientSecret: 'Client secret',
    clientSecretHint: 'Şifreli saklanır ve bir daha gösterilmez.',
    clientSecretKeep: 'Kayıtlı olanı korumak için boş bırakın.',
    domains: 'E-posta alan adları',
    domainsHint: 'Yalnızca bu alan adlarındaki adresler sağlayıcı üzerinden girer. gmail.com gibi genel sağlayıcılar kullanılamaz.',
    defaultRole: 'Yeni üyelerin rolü',
    defaultRoleHint: 'Sağlayıcı birini ilk kez gönderdiğinde alacağı rol.',
    roleMember: 'Üye',
    roleAdmin: 'Yönetici',
    enforce: 'Tek oturum açmayı zorunlu kıl',
    enforceHint: 'Bu alan adları için parola, GitHub ve Google girişi kapanır — birini sağlayıcınızda kapatmak erişimini kesmeye yeter.',
    saved: 'Kaydedildi',
    remove: 'Bağlantıyı kaldır',
    removeConfirm: 'Bu alan adlarındaki üyeler yeniden parolayla girer. Kimse erişimini kaybetmez.',
  },
  registries: {
    title: 'Özel registry\'ler',
    description: 'Pushify\'ın özel imajlarınızı çekmek için deploy sunucusunda kullandığı kimlik bilgileri.',
    listTitle: 'Registry\'ler',
    add: 'Registry ekle',
    remove: 'Kaldır',
    removeConfirm: 'Bu registry\'ye ihtiyaç duyan deploy\'lar, yeniden ekleyene kadar başarısız olur. Çalışan container\'lar etkilenmez.',
    empty: 'Özel registry yok',
    emptyDesc: 'Özel bir base imajdan build almak ya da projeyi doğrudan bir imajdan deploy etmek için ekleyin.',
    host: 'Registry',
    hostHint: 'Sadece host — ghcr.io, docker.io, registry.gitlab.com, registry.example.com:5000',
    username: 'Kullanıcı adı',
    password: 'Parola veya erişim token\'ı',
    passwordHint: 'Şifreli saklanır ve bir daha gösterilmez. Okuma yetkisi olan bir token yeterli.',
    name: 'Ad (isteğe bağlı)',
    lastUsed: 'Son kullanım {time}',
    neverUsed: 'Henüz bir deploy\'da kullanılmadı',
  },
  apiKeys: {
  ...
  notificationPrefs: {
    ...
    deploymentAlertsDesc: 'Bir deploy başarısız olduğunda ve tekrar düzeldiğinde e-posta al.',
  ...
  billing: {
    ...
    cancelScheduled: 'Aboneliğin {date} tarihinde sona eriyor. O güne kadar her şey çalışmaya devam eder.',
    resumeSubscription: 'Aboneliğimi sürdür',
    resumed: 'Abonelik sürdürüldü — eskisi gibi yenilenecek.',
  ...
  servers: {
    ...
    containersTitle: 'Burada ne çalışıyor',
    containersTotals: '{count} container · %{cpu} CPU · {mem} MB RAM',
    containersEmpty: 'Son 5 dakikada Pushify container’ı rapor edilmedi.',
    containersFailed: 'Container kullanımı yüklenemedi.',
    containersHint: 'Pay = bu uygulamanın, Pushify’ın bu sunucuda çalıştırdığı her şey içindeki dilimi. 30 saniyede bir yenilenir.',
  ...
  databases: {
    ...
    internalConnectionString: 'Bu sunucudaki uygulamalarınızdan',
    internalConnectionHint: 'Bağladığınız projeler bir sonraki deploy’da bunu DATABASE_URL (veya seçtiğiniz ad) olarak alır.',
    externalConnectionString: 'Sunucu dışından (harici erişim)',
    connectedProjects: 'Bağlı projeler',
    accessReadWrite: 'Okuma ve yazma',
    accessReadOnly: 'Salt okunur',
    readonlyBadge: 'salt okunur',
    readonlyNotForRedis: 'Redis’te salt okunur mod yok',
    resetRedeployHint: '{count} bağlı proje hâlâ eski şifreyi kullanıyor — yenisini bir sonraki deploy’da alır.',
    redeployConnected: 'Şimdi yeniden deploy et',
    redeployStarted: 'Deploy’lar başlatıldı',
    connectedProjectsHint: 'Bağlı her proje, bu veritabanının adresini bir sonraki deploy’da ortam değişkeni olarak alır.',
    noConnectedProjects: 'Henüz bağlı proje yok.',
    selectProject: 'Proje seçin',
    connectProject: 'Bağla',
    disconnectProject: 'Bağlantıyı kaldır',
    projectConnected: 'Bağlandı — uygulamak için projeyi yeniden deploy edin',
    projectDisconnected: 'Bağlantı kaldırıldı — uygulamak için projeyi yeniden deploy edin',
    otherServerNote: 'Başka sunucuda çalışıyor — harici erişim gerekir',
    ...
    externalAccessOffDesc: 'Yalnızca sunucudaki uygulamalar ve araçlar erişebilir',
    ...
    backupEvery: 'Yedekleme sıklığı',
    interval_1: 'Saatlik',
    interval_6: '6 saat',
    interval_12: '12 saat',
    interval_24: 'Günlük',
    interval_48: '2 gün',
    interval_168: 'Haftalık',
    worstCaseLoss: 'Sunucu kaybedilirse {loss} veri kaybedersiniz.',
    loss_1: 'en fazla 1 saatlik',
    loss_6: 'en fazla 6 saatlik',
    loss_12: 'en fazla 12 saatlik',
    loss_24: 'en fazla 1 günlük',
    loss_48: 'en fazla 2 günlük',
    loss_168: 'en fazla 1 haftalık',
    retentionDays: 'Saklama: {days} gün',
    lastBackup: 'Son yedek',
    backupHistory: 'Yedek Geçmişi',
    backupVerify: 'Geri yüklemeyi test et',
    backupVerifying: 'Geri yükleme test ediliyor…',
    backupVerified: 'Geri yükleme testi geçti',
    backupVerifyFailed: 'Geri yükleme başarısız',
    backupVerifySkipped: 'Test edilmedi',
    backupNeverVerified: 'Henüz hiçbir yedek geri yükleme testinden geçmedi',
    backupVerifiedSummary: 'Son yedek {date} tarihinde test edildi — {tables} tablo, {rows} {unit}',
    backupVerifyHint: 'Haftada bir, son yedek sunucunuzdaki geçici bir container’a geri yüklenir ve sayılır. Canlı veritabanınıza dokunulmaz.',
    backupVerifyStarted: 'Geri yükleme testi başladı — sonuç birkaç dakika içinde görünür',
    ...
    offsiteCopy: 'Dış kopya var',
    offsiteCopyHint: 'Bu yedeğin bir kopyası, veritabanının çalıştığı sunucunun dışında tutuluyor.',
    offsiteFailed: 'Sadece bu sunucuda',
    offsiteFailedHint: 'Bu yedek yalnızca veritabanının çalıştığı sunucuda duruyor — o sunucu giderse yedek de gider.',
  ...
  admin: {
    title: 'Yönetim',
    eyebrow: 'Platform',
    subtitle: 'Kim kaydoldu, ne yaptı — hepsi burada.',
    navSection: 'Platform',
    navOverview: 'Genel bakış',
    navUsers: 'Kullanıcılar',
    navActivity: 'Aktivite',
    navSignins: 'Girişler',
    twoFactorTitle: 'Burası iki adımlı doğrulama istiyor',
    twoFactorDesc: 'Hesabın operatör listesinde, ama yönetim paneli yalnızca iki adımlı doğrulaması açık hesaplara açılıyor.',
    twoFactorCta: 'İki adımlı doğrulamayı aç',
    loadError: 'Sayfa yüklenemedi. Biraz sonra tekrar dene.',
    retry: 'Tekrar dene',
    statUsers: 'Kullanıcı',
    statNewWeek: 'Bu hafta yeni',
    statActiveWeek: 'Bu hafta aktif',
    statActiveHint: 'giriş yaptı ya da bir şey yaptı',
    statPaying: 'Ödeme yapan organizasyon',
    verified: 'doğrulanmış',
    with2fa: '2FA açık',
    funnelTitle: 'İnsanlar nereye kadar geliyor',
    funnelHint: 'Kaydolan herkese oranı',
    funnelRegistered: 'Kaydoldu',
    funnelVerified: 'E-postayı doğruladı',
    funnelProject: 'Proje oluşturdu',
    funnelDeployed: 'Deploy denedi',
    funnelLive: 'Deploy canlıya çıktı',
    funnelServer: 'Sunucu bağladı',
    funnelDatabase: 'Veritabanı oluşturdu',
    funnelPaid: 'Ücretli planda',
    last30Title: 'Son 30 gün',
    signups: 'Kayıtlar',
    signins: 'Girişler',
    peak: 'zirve',
    deploysTitle: 'Deploy\'lar',
    allTime: 'Tüm zamanlar',
    thisWeek: 'Bu hafta',
    failedThisWeek: 'Bu hafta başarısız',
    ...
    sortNewest: 'En yeni',
    sortLastSeen: 'Son görülme',
    sortMostActive: 'En aktif',
    usersTotal: 'kullanıcı',
    usersEmpty: 'Bu aramayla eşleşen kimse yok.',
    colUser: 'Kullanıcı',
    colPlan: 'Plan',
    colUsage: 'Proje · Deploy · Sunucu · DB',
    colLastSeen: 'Son görülme',
    colJoined: 'Katıldı',
    never: 'Hiç',
    methodPassword: 'E-posta',
    methodGithub: 'GitHub',
    methodGoogle: 'Google',
    methodTwoFactor: '2FA kodu',
    failedShort: 'başarısız',
    backToUsers: 'Tüm kullanıcılar',
    joined: 'Katıldı',
    lastSeen: 'Son görülme',
    emailVerified: 'E-posta doğrulandı',
    emailUnverified: 'E-posta doğrulanmadı',
    twoFactorOn: '2FA açık',
    twoFactorOff: '2FA kapalı',
    passwordSet: 'Şifre var',
    oauthOnly: 'Yalnızca sağlayıcıyla giriş yapıyor',
    orgsTitle: 'Organizasyonlar',
    projectsTitle: 'Projeler',
    serversTitle: 'Sunucular',
    databasesTitle: 'Veritabanları',
    sessionsTitle: 'Açık oturumlar',
    timelineTitle: 'Zaman tüneli',
    timelineEmpty: 'Henüz bir şey yok — bu hesap yalnızca kaydolmuş.',
    members: 'üye',
    wallet: 'cüzdan',
    deploys: 'deploy',
    lastDeploy: 'son deploy',
    noDeploysYet: 'henüz deploy yok',
    expires: 'bitiş',
    managed: 'yönetilen',
    byos: 'kendi sunucusu',
    sectionEmpty: 'Yok',
    evRegister: 'Kaydoldu',
    evLogin: 'Giriş yaptı',
    evLoginFailed: 'Başarısız giriş',
    evTwoFactorRequired: 'Şifre doğru, 2FA bekleniyor',
    evTwoFactorFailed: 'Yanlış 2FA kodu',
    tlProject: 'Proje oluşturdu',
    tlDeploy: 'Deploy',
    tlServerManaged: 'Sunucu oluşturdu',
    tlServerByos: 'Sunucu bağladı',
    tlDatabase: 'Veritabanı oluşturdu',
    via: 'ile',
    activityTitle: 'Herkes, her şey',
    activityEmpty: 'Henüz aktivite yok.',
    signinsTitle: 'Giriş geçmişi',
    signinsEmpty: 'Henüz kayıtlı giriş yok. Geçmiş bu sürümle başlıyor.',
    pageOf: '/',
    prev: 'Önceki',
    next: 'Sonraki',
    unknownUser: 'Silinmiş kullanıcı',
    filterAll: 'Herkes',
    filterUnverified: 'E-postayı doğrulamadı',
    filterNoProject: 'Henüz proje yok',
    filterFailing: 'Sadece başarısız deploy',
    failuresTitle: 'Deploy\'lar neden başarısız oluyor',
    ...
    blameServer: 'Sunucu',
    blameProject: 'Proje',
    catOutOfMemory: 'Bellek yetmedi',
    catDiskSpace: 'Disk doldu',
    catPlatformNative: 'Native modül (platform)',
    catDockerBuild: 'Docker build hatası',
    catApplicationBuild: 'Uygulama build hatası',
    catContainerStart: 'Konteyner başlamadı',
    catServerCapacity: 'Sunucu meşgul',
    catProjectConfig: 'Proje yapılandırması',
    catRepositoryAccess: 'Repo erişimi',
    catUnknown: 'Sınıflandırılamadı',
  },
};
